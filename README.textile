...
"oui_player_abcnews":https://github.com/NicolasGraph/oui_player_abcnews is a "oui_player":https://github.com/NicolasGraph/oui_player v2+ extension to easily embed "ABC News":https://abcnews.go.com/ provided videos in "Textpattern":https://textpattern.com/ powered websites.
...
oui_player_abcnews's minimum requirements:
...
# "Download":https://github.com/NicolasGraph/oui_player_abcnews/releases the compiled plugin file or the source to compile a customized file.
...
# Install oui_player_abcnews:
@$ composer require oui/oui_player_abcnews@
...
bc. $ composer update oui/oui_player_abcnews
...
bc. $ composer remove oui/oui_player_abcnews

h2. Tags and parameters

h3. oui_abcnews vs oui_player

While the @<txp:oui_player />@ tag is able to embed any video from any extension-related provider, the @<txp:oui_abcnews />@ tag is a shortcut to embed ABC News videos only. It is strictly equivalent to @<txp:oui_player provider="abcnews" />@.
...
h3. oui_if_abcnews vs oui_if_player

p. While the @<txp:oui_if_player>…</txp:oui_if_player>@ tag is able to check an URL against any URL from any extension-related provider, the @<txp:oui_if_abcnews>…</txp:oui_if_abcnews>@ tag is a shortcut to check an URL against ABC News related URL schemes only. It is strictly equivalent to @<txp:oui_if_player provider="abcnews">…</txp:oui_if_player>@.
...
bc(language-markup xml). <txp:oui_player />

"oui_player":https://github.com/NicolasGraph/oui_player preference related field value: @https://abcnews.go.com/video/embed?id=55148128@.

h3. Embed a player by defining its provider and a media ID through attributes

bc(language-markup xml). <txp:oui_player provider="abcnews" play="55148128" />

…or:

bc(language-markup xml). <txp:oui_abcnews play="55148128" />

h3. Conditionally embed a player using attributes

bc(language-markup xml).. <txp:oui_if_player provider="abcnews" play="https://abcnews.go.com/Technology/video/nintendo-release-nes-classic-edition-console-55148128">
    <txp:oui_player />
</txp:oui_if_player>

p. …or:

bc(language-markup xml).. <txp:oui_if_abcnews play="https://abcnews.go.com/Technology/video/nintendo-release-nes-classic-edition-console-55148128">
    <txp:oui_abcnews />
</txp:oui_if_abcnews>
...
oui_player_abcnews version 1.0.0, Copyright (C) 2018 Nicolas Morand
...
* "oui_player_abcnews v1.0.0-beta":https://github.com/NicolasGraph/oui_player_abcnews/releases/tag/1.0.0-beta (2018-06-24)
* "oui_player v1.3.1":https://github.com/NicolasGraph/oui_player/releases/tag/1.3.1 (2017-07-13)
