...
bc(language-markup). <txp:oui_player provider="abcnews" play="55148128" />

…or:

bc(language-markup). <txp:oui_abcnews play="55148128" />

h3. Conditionally embed a player using attributes

bc(language-markup).. <txp:oui_if_player provider="abcnews" play="https://abcnews.go.com/Technology/video/nintendo-release-nes-classic-edition-console-55148128">
    <txp:oui_player />
</txp:oui_if_player>

p. …or:

bc(language-markup).. <txp:oui_if_abcnews play="https://abcnews.go.com/Technology/video/nintendo-release-nes-classic-edition-console-55148128">
    <txp:oui_abcnews />
</txp:oui_if_abcnews>
